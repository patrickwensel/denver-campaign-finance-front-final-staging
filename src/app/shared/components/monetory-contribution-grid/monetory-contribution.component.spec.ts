...
import { MonetoryContributionComponent } from './monetory-contribution.component';

describe('MonetoryContributionComponent', () => {
  let component: MonetoryContributionComponent;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [ MonetoryContributionComponent ],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(MonetoryContributionComponent);
