...
import { PublicCityReportComponent } from './public-city-report.component';

describe('PublicCityReportComponent', () => {
  let component: PublicCityReportComponent;
  let fixture: ComponentFixture<PublicCityReportComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [ PublicCityReportComponent ],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(PublicCityReportComponent);
