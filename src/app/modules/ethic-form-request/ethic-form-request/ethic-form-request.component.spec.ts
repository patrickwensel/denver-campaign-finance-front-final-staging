...
import { EthicFormRequestComponent } from './ethic-form-request.component';

describe('EthicFormRequestComponent', () => {
  let component: EthicFormRequestComponent;
  let fixture: ComponentFixture<EthicFormRequestComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(EthicFormRequestComponent);
