...
describe('LobbyistRelationshipsComponent', () => {
  ...
  test('form invalid when empty', () => {
    component.LobbyRelationshipForm.controls.lobbyist.setValue('');
    component.LobbyRelationshipForm.controls.officialName.setValue('');
    component.LobbyRelationshipForm.controls.officialTitle.setValue('');
    component.LobbyRelationshipForm.controls.relationship.setValue('');
    component.LobbyRelationshipForm.controls.entityName.setValue('');
    expect(component.LobbyRelationshipForm.valid).toBeFalsy();
  });
});
