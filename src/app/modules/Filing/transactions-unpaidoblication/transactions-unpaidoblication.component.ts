...
import { CommonMethods, MasterDataService, MasterUrlService, LocalstorageService, ErrorMessageService, SnackbarService } from 'src/app/core';
import { ClientService } from 'src/app/core/api-services/client.service';

@Component({
  selector: 'app-transactions-unpaidoblication',
  templateUrl: './transactions-unpaidoblication.component.html',
  styleUrls: ['./transactions-unpaidoblication.component.scss']
})
export class TransactionsUnpaidoblicationComponent implements OnInit {
  static_data: any;
  ...
  saveExpenditure(){
    if(this.expenditure.valid){
      let data={
        ...
        "transactionAmount": parseFloat(this.expenditure.value.amount),
      ...
      this.service.postData(this.urlService.saveUnpaidObligation,data).subscribe((res)=>{
