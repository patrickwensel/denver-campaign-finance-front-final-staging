...
describe('ChangePasswordComponent', () => {
  ...
  test('form invalid when empty', () => {
    component.frmchangepwd.controls.newpassword.setValue('');
    component.frmchangepwd.controls.confirmpassword.setValue('');
    component.frmchangepwd.controls.oldpassword.setValue('');
    expect(component.frmchangepwd.valid).toBeFalsy();
  });
});
